...
import com.beem.TastyMap.security.verification.emailVerify.entity.EmailEntity;
import com.beem.TastyMap.security.verification.emailVerify.repo.EmailRepo;
...
public class UserService implements UserDetailsService {
    ...
    public LoginResponseDTO login(LoginRequestDTO dto, String userAgent) {
        ...
        UserEntity user = userRepo.findByUsernameIncludingDeleted(username)
